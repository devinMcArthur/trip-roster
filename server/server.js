...
app.get('/podcast/feed', async (req, res) => {
  try {
    ...
    feed.addItem({
      ...
      url: 'https://www.dropbox.com/s/3h6cnshbbvuzkjx/Conversation%201.mp3?raw=1', // link to the item
      ...
      lat: 45.622459, //optional latitude field for GeoRSS
      long: -61.991421, //optional longitude field for GeoRSS
      enclosure: { url: 'https://www.dropbox.com/s/3h6cnshbbvuzkjx/Conversation%201.mp3?raw=1', size: '215142742', type: 'audio/mpeg' }, // optional enclosure
      itunesAuthor: 'Devin McArthur & Curtis Colbary',
      itunesExplicit: true,
      itunesSubtitle: 'Stories From The Nish',
